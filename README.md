...
2. For certain older editions of Fireboy and Watergirl 1—4, Please use the `json1.dll` plugin instead of `json.dll`. The latter will emit a newer json format which does not work with the game. More recent editions, on the other hand, require the newer format.
